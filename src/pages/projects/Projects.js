...
export default function Projects(props) {
  ...
  const filteredRepos = useMemo(() => {
    return ProjectsData.data.filter((repo) => {
      const languageNames =
        repo.languages?.map((l) => l.name.toLowerCase()) || [];
      const technologyNames =
        repo.technologies?.map((t) => t.toLowerCase()) || [];
  ...
  return (
    <div className="projects-main">
        ...
        <Fade bottom duration={2000} distance="40px">
          <div className="projects-heading-div">
            <div className="scroll-down-btn-wrapper">
              ...
              >
                <span role="img" aria-label="Nedover pekende hånd">
                  👇
                </span>{" "}
                {language === "no"
      ...
      {/* Search + tags */}
      <div className="projects-tag-search-wrapper" ref={wrapperRef}>
